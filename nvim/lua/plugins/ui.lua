return {
    ...
    },
    {
        ...
        config = function()
            ...
            local bubbles = {
                normal = { a = { fg = colors.black, bg = colors.lighter_grey }, b = { fg = colors.white, bg = colors.grey }, c = { fg = colors.white } },
                insert = { a = { fg = colors.black, bg = colors.white } },
                visual = { a = { fg = colors.black, bg = colors.light_grey } },
    ...
    { "lukas-reineke/indent-blankline.nvim", main = "ibl", opts = { indent = { char = "│" }, scope = { enabled = false } } },
    {
        ...
        config = function()
            ...
            dashboard.section.header.val = { " ", " ", " ", " ", " Neovim (better than vscode) ", " ", " ", " " }
